...
namespace LINQSamples.Migrations
{
    ...
    [Migration("20240603184841_UpdateTo")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LINQSamples.Data.AlphabeticalListOfProduct", b =>
                {
            ...
            modelBuilder.Entity("LINQSamples.Data.Category", b =>
                {
                    b.Property<int>("CategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LINQSamples.Data.CategorySalesFor1997", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(15)
            ...
            modelBuilder.Entity("LINQSamples.Data.CurrentProductList", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LINQSamples.Data.Customer", b =>
                {
            ...
            modelBuilder.Entity("LINQSamples.Data.CustomerAndSuppliersByCity", b =>
                {
                    b.Property<string>("City")
                        .HasMaxLength(15)
                        .HasColumnType("nvarchar(15)");
            ...
            modelBuilder.Entity("LINQSamples.Data.CustomerCustomerDemo", b =>
                {
                    b.Property<string>("CustomerId")
                        .HasMaxLength(5)
                        .HasColumnType("nchar(5)")
            ...
            modelBuilder.Entity("LINQSamples.Data.CustomerDemographic", b =>
                {
                    b.Property<string>("CustomerTypeId")
                        .HasMaxLength(10)
                        .HasColumnType("nchar(10)")
            ...
            modelBuilder.Entity("LINQSamples.Data.Employee", b =>
                {
            ...
            modelBuilder.Entity("LINQSamples.Data.EmployeeTerritory", b =>
                {
                    b.Property<int>("EmployeeId")
                        .HasColumnType("int")
                        .HasColumnName("EmployeeID");
            ...
            modelBuilder.Entity("LINQSamples.Data.Invoice", b =>
                {
                    b.Property<string>("Address")
                        .HasMaxLength(60)
                        .HasColumnType("nvarchar(60)");
            ...
            modelBuilder.Entity("LINQSamples.Data.Order", b =>
                {
                    b.Property<int>("OrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LINQSamples.Data.OrderDetail", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int")
                        .HasColumnName("OrderID");
            ...
            modelBuilder.Entity("LINQSamples.Data.OrderDetailsExtended", b =>
                {
                    b.Property<float>("Discount")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("LINQSamples.Data.OrderSubtotal", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int")
                        .HasColumnName("OrderID");
            ...
            modelBuilder.Entity("LINQSamples.Data.OrdersQry", b =>
                {
                    b.Property<string>("Address")
                        .HasMaxLength(60)
                        .HasColumnType("nvarchar(60)");
            ...
            modelBuilder.Entity("LINQSamples.Data.Product", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LINQSamples.Data.ProductSalesFor1997", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(15)
            ...
            modelBuilder.Entity("LINQSamples.Data.ProductsAboveAveragePrice", b =>
                {
                    b.Property<string>("ProductName")
                        .IsRequired()
                        .HasMaxLength(40)
            ...
            modelBuilder.Entity("LINQSamples.Data.ProductsByCategory", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(15)
            ...
            modelBuilder.Entity("LINQSamples.Data.QuarterlyOrder", b =>
                {
                    b.Property<string>("City")
                        .HasMaxLength(15)
                        .HasColumnType("nvarchar(15)");
            ...
            modelBuilder.Entity("LINQSamples.Data.Region", b =>
                {
            ...
            modelBuilder.Entity("LINQSamples.Data.SalesByCategory", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int")
                        .HasColumnName("CategoryID");
            ...
            modelBuilder.Entity("LINQSamples.Data.SalesTotalsByAmount", b =>
                {
                    b.Property<string>("CompanyName")
                        .IsRequired()
                        .HasMaxLength(40)
            ...
            modelBuilder.Entity("LINQSamples.Data.Shipper", b =>
                {
            ...
            modelBuilder.Entity("LINQSamples.Data.SummaryOfSalesByQuarter", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int")
                        .HasColumnName("OrderID");
            ...
            modelBuilder.Entity("LINQSamples.Data.SummaryOfSalesByYear", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int")
                        .HasColumnName("OrderID");
            ...
            modelBuilder.Entity("LINQSamples.Data.Supplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LINQSamples.Data.Territory", b =>
                {
                    b.Property<string>("TerritoryId")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
            ...
            modelBuilder.Entity("LINQSamples.Data.CustomerCustomerDemo", b =>
                {
                    b.HasOne("LINQSamples.Data.Customer", "Customer")
                        .WithMany("CustomerCustomerDemos")
                        .HasForeignKey("CustomerId")
                        .IsRequired()
                        .HasConstraintName("FK_CustomerCustomerDemo_Customers");

                    b.HasOne("LINQSamples.Data.CustomerDemographic", "CustomerType")
                        .WithMany("CustomerCustomerDemos")
            ...
            modelBuilder.Entity("LINQSamples.Data.Employee", b =>
                {
                    b.HasOne("LINQSamples.Data.Employee", "ReportsToNavigation")
            ...
            modelBuilder.Entity("LINQSamples.Data.EmployeeTerritory", b =>
                {
                    b.HasOne("LINQSamples.Data.Employee", "Employee")
                        .WithMany("EmployeeTerritories")
                        .HasForeignKey("EmployeeId")
                        .IsRequired()
                        .HasConstraintName("FK_EmployeeTerritories_Employees");

                    b.HasOne("LINQSamples.Data.Territory", "Territory")
                        .WithMany("EmployeeTerritories")
            ...
            modelBuilder.Entity("LINQSamples.Data.Order", b =>
                {
                    ...
                    b.HasOne("LINQSamples.Data.Shipper", "ShipViaNavigation")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("LINQSamples.Data.OrderDetail", b =>
                {
                    b.HasOne("LINQSamples.Data.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .IsRequired()
                        .HasConstraintName("FK_Order_Details_Orders");

                    b.HasOne("LINQSamples.Data.Product", "Product")
                        .WithMany("OrderDetails")
            ...
            modelBuilder.Entity("LINQSamples.Data.Product", b =>
                {
                    b.HasOne("LINQSamples.Data.Category", "Category")
                        .WithMany("Products")
                        .HasForeignKey("CategoryId")
                        .HasConstraintName("FK_Products_Categories");

                    b.HasOne("LINQSamples.Data.Supplier", "Supplier")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("LINQSamples.Data.Territory", b =>
                {
                    b.HasOne("LINQSamples.Data.Region", "Region")
